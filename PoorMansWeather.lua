...
---------------------------------------------------------------------->8---------------------
--  you can modify this to change the number of seconds between nearest weather checks ------
local updateConditionsSeconds = 300
---------------------------------------------------------------------------------------------
...
dataref("LJK_temp_sl","sim/weather/temperature_sealevel_c","writable")
dataref("LJK_dewpt_sl","sim/weather/dewpoi_sealevel_c","writable") -- does not look writable
...
--visibility_statute_mi,altim_in_hg,sea_level_pressure_mb,corrected,auto,auto_station,maintenance_indicator_on,no_signal,
--lightning_sensor_off,freezing_rain_sensor_off,present_weather_sensor_off,wx_string,sky_cover,cloud_base_ft_agl,sky_cover,
--cloud_base_ft_agl,sky_cover,cloud_base_ft_agl,sky_cover,cloud_base_ft_agl,flight_category,three_hr_pressure_tendency_mb,
--maxT_c,minT_c,maxT24hr_c,minT24hr_c,precip_in,pcp3hr_in,pcp6hr_in,pcp24hr_in,snow_in,vert_vis_ft,metar_type,elevation_m

-- 1 foot = .3048 meters
-- 2100 feet = 640 meters
-- got this formula on the web but forgot where, sorry
...
local function setConditionsDataRefs()
	...
	LJK_temp_sl = weatherTable[closestIndex].parsed[5]
	LJK_dewpt_sl = weatherTable[closestIndex].parsed[6]
